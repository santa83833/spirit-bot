...
if (Config.WORKTYPE == 'private') {
    ...
    r_text[1] = "*╔══■□💝sᴘɪʀɪᴛ-sᴇʀ💝■□══╗*\n           \n*⚜═sᴘɪʀɪᴛ-sᴇʀ═⚜*\n\n*𝕆𝕨𝕟𝕖𝕣 sᴘɪʀɪᴛ- - https://api.whatsapp.com/send?phone=15612403940&text=Please%20add%20sᴘɪʀɪᴛsᴇʀ%20bot%20ɢʀᴏᴜᴘ%20💝*\n*            *\n*╚══■□💝sᴘɪʀɪᴛ-sᴇʀ💝■□══╝*\n\n*▷Cʀᴇᴀᴛᴇʀ: Sᴘɪʀɪᴛ sᴇʀ ✝︎*"
    ...
    await message.client.sendMessage(
        ...
        r_text[1] = "*Gɪᴛ Lɪɴᴋs*\n           *\n🌟═sᴘɪʀɪᴛ-sᴇʀ ᴏᴡɴᴇʀ sᴘɪʀɪᴛ- »« ʀᴇᴀʟ ɴᴀᴍᴇ-sᴘɪʀɪᴛ sᴇʀ.ᴍᴜʜᴀᴍᴍᴇᴅ═🌟*\n\n*🔅https://github.com/SPlRlT-YT/spirit-bot*"
