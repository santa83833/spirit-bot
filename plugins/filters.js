...
''&&&'            if (pattern.test(message.message)) {
                await message.client.'(message.jid,filter.dataValues.text, MessageType.text, {quoted: message.data});
            }'
        }
    );
}));
